...
//        positions = centralizedTesting(scenario, target1, target2, this.actions, this.existing_buttons);
        ...
        individualTraining(scenario, target1, target2, target3, this.singular_actions, this.existing_buttons);
//        positions = individualTesting(scenario, target1, target2, target3, this.singular_actions, this.existing_buttons);
...
//        saveToTXT("C:/Users/bruno/Desktop/Ambiente de Trabalho/" + scenario + "_individual_agent1.txt", positions.object2);
    ...
    public void individualTraining(String scenario, String target1, String target2, String target3, ArrayList<String> singular_actions, ArrayList<String> existing_buttons) throws Exception {
        ...
        individual_train_new.create_policy_train(scenario, target1, target2, target3, singular_actions, existing_buttons);
        Bruno_2agents_individual_MDP_train.close();
    }

    public Tuple<ArrayList<Vec3>, ArrayList<Vec3>> individualTesting(String scenario, String target1, String target2, String target3, ArrayList<String> singular_actions, ArrayList<String> existing_buttons) throws Exception {
        Tuple<ArrayList<Vec3>, ArrayList<Vec3>> Positions = null;
        ...
        Positions = individual_test.run(scenario, target1, target2, target3, singular_actions, existing_buttons);
