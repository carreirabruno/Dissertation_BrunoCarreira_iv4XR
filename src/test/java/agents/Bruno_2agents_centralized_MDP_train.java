...
//        TestSettings.USE_GRAPHICS = true;
     ...
     */
    @Test
    public void create_policy_train(String scenario_filename, String target1, String target2, ArrayList<String[]> actions, ArrayList<String> singular_actions, ArrayList<String> existing_buttons) throws InterruptedException, IOException {

        System.out.println(LocalDateTime.now());

        this.actions = actions;
        this.singular_actions = singular_actions;
