...
//            goalPosition = new Vec3((int)agent_pos.x - DISTANCE_TO_TRAVEL, (int)agent_pos.y, (int)agent_pos.z);
//            goalPosition = new Vec3(agent_pos.x - DISTANCE_TO_TRAVEL, agent_pos.y, agent_pos.z);
            goalPosition = new Vec3((int)(agent_pos.x - DISTANCE_TO_TRAVEL), agent_pos.y, agent_pos.z);
...
//            goalPosition = new Vec3((int)agent_pos.x, (int)agent_pos.y, (int)agent_pos.z + DISTANCE_TO_TRAVEL);
//            goalPosition = new Vec3(agent_pos.x, agent_pos.y, agent_pos.z + DISTANCE_TO_TRAVEL);
            goalPosition = new Vec3(agent_pos.x, agent_pos.y, (int)(agent_pos.z + DISTANCE_TO_TRAVEL));
...
//                            TacticLib.explore(), //explore if the goal position is unknown
    ...
    public static GoalStructure entityIsInteracted_Bruno(LabRecruitsTestAgent agent, String entityId) {
        //move to the object
        Goal goal1 = goal(String.format("This entity is in interaction distance: [%s]", entityId))
                .toSolve((BeliefState belief) -> agent.getState().canInteract(entityId));
//        Goal goal1 = goal(String.format("This entity is in interaction distance: [%s]", entityId))
//                .toSolve((BeliefState belief) -> true);
